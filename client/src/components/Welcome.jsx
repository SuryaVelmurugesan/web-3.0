        ...
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                ...
                <div className="flex flex-col flex-1 item-center justify-start w-full mf:mt-0 mt-10">
                    ...
                    <div className="p-5 sm:w-96 w-full flex flex-col justify-col items-center blue-glassmorpism">
            ...
            {isLoading ? (
                ...
                className="text-white w-full mt-2 border-[1px] p-2 border-[#1f53d6] rounded-full cursor-pointer"
                >
                    Send Now
                </button>
            )
